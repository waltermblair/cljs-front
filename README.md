...
* [`src/gfront/`](src/gfront/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/gfront/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `gfront` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/gfront/config.cljs) defaults to `true` in
...
```clj
(ns gfront.example
  (:require [gfront.config :as config])
